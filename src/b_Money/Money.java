...
public class Money implements Comparable {
	 ...
	 */
	public Integer getAmount() { //I think that there is a mistake in the documentation. It says to return in Double type
        return this.amount; //But everything is set up to work with ints and documentation of method toString says that we represent decimal numbers with ints
	}
	 ...
	 */
	public String toString() { //double because I want to get the dot between numbers like in the example "10.5 SEK"
        return (double) this.amount/100 + " " + this.currency.getName();
	}
